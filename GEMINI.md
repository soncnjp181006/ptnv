# GEMINI.md — Quy Chuẩn Hệ Thống & Quản Trị Cho Gemini CLI (.agent-system/memory/)

Tài liệu này là **Chỉ Thị Tối Cao (System Governance Directive)** dành riêng cho **Gemini CLI** khi hoạt động trong workspace này. Gemini CLI tự động nạp tệp này để thiết lập ngữ cảnh làm việc.

---

## ⚠️ BẮT BUỘC NẠP BỘ NHỚ QUẢN TRỊ (MANDATORY MEMORY INGESTION)

Mỗi khi nhận lệnh từ người dùng hoặc thực thi tác vụ lập trình, Gemini CLI **BẮT BUỘC PHẢI ĐỌC VÀ TUÂN THỦ** các tệp quy chuẩn tại thư mục `.agent-system/memory/`:
...
| **5. Quy Trình** | `.agent-system/memory/workflows/workflows.md` | **Quy trình 10 bước chuẩn hóa**: Deep-Thinking ➔ Clarify tuần tự 200+ ➔ Flowchart 3 tầng ➔ Plan ➔ Tasks ➔ Implement ➔ Đối chiếu ➔ Mock Test ➔ Test thực tế có timeout ➔ Verify. |
...
## 🛠️ CÁC LỆNH SLASH KHẢ DỤNG TRONG GEMINI CLI (.gemini/commands/)
...
1. **Host-Centric AI**: Gemini CLI là AI Engine chính. Framework không yêu cầu Model hay API key riêng.
